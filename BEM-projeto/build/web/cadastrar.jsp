  ...
  <body>
    ...
    <div  class="container">
      ...
      <!-- Page Heading/Breadcrumbs -->
        <h3 align="center" class="display-8"> Oii, como você deseja se cadastrar no 
    ...
    <br><br>
        <div class="container">
            <div id="figure">
                <a class="menuLogin" href="cadastroProfissional/index.jsp">
                    <figure class="fig-pic">
                        <img src="imgs/imgsSingIn/medicos-bem.png" alt="..." class="img-rounded">
                        <figcaption>Profissional</figcaption>
                    </figure>
                </a>
                <a class="menuLogin" href="cadastroUsuario/index.jsp">
                    <figure class="fig-pic">
                        <img src="imgs/imgsSingIn/pacientes-bem.png" alt="..." class="img-rounded">
