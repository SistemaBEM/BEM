...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">       
        ...
        <div class="jumbotron">
            <h3> Veja o histórico das suas avaliações =D </h3>
            <br/>
            ...
            <table class="table">
                ...
                <c:forEach var="ap" items="${lista}" varStatus="ordem">
                    <tr>
                        <td><center>${ap.nomeProf}</td>
                        <td><center>${ap.nota}</center></td>
                        <td><center>${ap.comentario}</center></td>
                       <c:if test="${ap.statusValidacaoApply == false}">
                            <td><center>Em espera...</center></td>
                        </c:if>
                        <c:if test="${ap.statusValidacaoApply == true}">
                            <td><center>Validado</center></td>
                        </c:if>
                    </tr>
                </c:forEach>
                </tbody>
